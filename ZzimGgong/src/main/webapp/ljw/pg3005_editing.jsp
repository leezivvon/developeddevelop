...
%>
	...
	<c:set var="waiting" value="${daoo.curntSitu('alsn0527@naver.com')}"/> 	 <%-- 가게/신청정보 출력 --%>
...
<script type="text/javascript">
	...
	//원격줄서기 버튼 //현재날짜
	var today = new Date();
	var wdate = today.getFullYear()+"/"+(today.getMonth()+1)+"/"+(today.getDate()+2)
	...
	//실시간예약 버튼 클릭 시
	crstRsvButtonOb.onclick = function(){
