...
@Controller
public class A02_ReqExpController {//컨테이너(dispatcher-servlet)에 <bean 해서 선언

	// http://localhost:7080/springweb/call01.do?name=홍길동
	@RequestMapping("/call01.do")
	public String call01(@RequestParam("name") String name) { //querystring으로 넘겼을 때 받는 값
	...
	public String call04(@RequestParam("num01") int num01, @RequestParam("num02") int num02) {
