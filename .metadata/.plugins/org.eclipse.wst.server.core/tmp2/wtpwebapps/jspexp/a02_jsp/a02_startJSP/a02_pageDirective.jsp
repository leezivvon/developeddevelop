<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    session = "true"
    %>
    <%--  session = "true" // 대부분의 프로그램의 boolean유형의 default설정이 false인데 directive의 경우에는 default가 true이다 --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
2. 주요 속성
	...
	isErrorPate :에러 페이지인지의 여부를 지정	
		
# page 디렉티브 : import 속성
1. jsp 페이지에서 사용할 클래스(인터페이스)지정
2. import 속성의 사용 예
	page import="java.util.Calendar"
	page import="java.util.*, jsepexp.vo.*"
