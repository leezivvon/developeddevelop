...
<div class="container">
	...
	<!-- 
		...
		현재 view를 호출하는 action과 이름이 같으면 생락가능 
	-->
	<form action="${path}/call10.do" id="frm01" class="form-inline"  method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  	<input name="price" class="form-control mr-sm-2" placeholder="물건가격" />
	  	<input name="cnt" class="form-control mr-sm-2" placeholder="물건개수" />
