...
2. 각 프레임간의 데이터 전송 
	1) 클라이언트단의 BOM객체와 DOM객체간의 접근 방법
		window나 frame인 BOM(브라우저 모델)은 DOM상위 객체이다
	2) 각 개체의 접근 방법
		- 부모 객체
		BOM객체명.document.querySelector("해당 DOM의 하위 객체") 형식으로 접근이 가능하다
	3) 하위 BOM객체에서 상위 객체의 DOM접근 처리
...
<script type="text/javascript">
	...
	// ex) 버튼을 추가하여 프레임2를 접근해서 타이틀을 변경하고 글자색도 변경하는 이벤트 핸들러 call02를 구현하여 처리
	function call02(){
		var fm02H2Ob = frame02.document.querySelector("h2")
		fm02H2Ob.innerText="frame02의 내용 변경"
		fm02H2Ob.style.color="green"
	}
...
<%-- <h2>프레임3</h2> --%>
<a href="a05_sub04.jsp" target="frame02">프레임2의 페이지 변경</a>
<%-- <h2>프레임4</h2> --%>
<a href="javascript:call03()">윈도우 객체 로딩</a>
