...
public class A08_InputArgs {
	...
	public static void main(String[] args) {
		...
		2. 처리 프로세스
		java A08_InputArgs 사과바나나 실행하면, 문자열 사과 바나나가
		String[] args로 할당되어 {"사과", "바나나"}로 처리된다.  << 자바의 특징
		ex) 대부분 언어. ["사과","바나나"]
		3. 배열 문자열로 할당된 데이터는 
		  java A08_InputArgs 문자열1    문자열2     문자열3 
		  java A08_InputArgs  사과      바나나      딸기
		  java A08_InputArgs "사 과"  "바 나 나"   "딸 기"
		   - 띄어쓰기를 하나의 문자열에 포함시켜 처리할 때는 " "로 씌워서 처리한다
		 args[0]
		 args[1]
		 args[2]
		 args[3]
		...
		*/
		...
		// 외부에서 매개변수로 데이터를 받아서 첫번째 데이터를 가져온것
		
		System.out.println("두번째:"+args[1]);
		System.out.println("세번째:"+args[2]);
	
		// A09_InputArgsExp.java 만들고 best 점심메뉴3가지를 입력해서 출력되게
