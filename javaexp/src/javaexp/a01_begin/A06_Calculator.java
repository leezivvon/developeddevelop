...
public class A06_Calculator {
	...
	public static void main(String[] args) {
		...
		1. 자바프로그램에서 산술연산자
		  1) + : 문자열 이어주는 역할
		         숫자는 합산처리
		         cf) 주의
		         "25" 형변환이 된 숫자형태의 문자열은 문자열 이어주는 처리가 된다.
		  ...
		  2) - : 뺄셈
		         ...
		         System.out.println(""+25-5); (X)-에러 발생
		         System.out.println(""+(25-5)); "20"
		  3) * : 곱셈
		  ...
		  4) / : 나눗셈(자바만)
		         ...
		         System.out.println((double)10/(double)3); 3.3333
		  5) % : 나머지값 (~몫)
		         27%5   2
		         11%2   1
                 cf) 정수형/정수형 : 몫
                 ...
                 ps) 반복적인 처리프로세스에서 활용도가 높다 
                     1~10까지 중에 짝수만 합산한다.  if(cnt%2==0)
                     홀수인 번호인 경우에 특정처리를 한다. if(cnt%2==1)
	...
	System.out.println(""+num01 + num02); //앞에 문자열이 선언돼서 
	System.out.println(""+(num01 + num02));
	System.out.println(""+(num01 - num02));
//  System.out.println(""+ num01 - num02); 에러발생
	...
	System.out.println(25/7.0); // 정수/실수
	System.out.println(25/(double)7); // casting으로 형변환처리
	System.out.println("나머지(%):" + 25%7);
	// ex) 어떤 수를 홀수 짝수 구분하기 위한 처리를 할 때 나머지 연산자 사용
	System.out.println(1%2);
	System.out.println(2%2);
	System.out.println(3%2);
	
	/*
	예제1) 사과(2000)을 5개 구매했을 때, 총계
	예제2) 현재 가지고 있는 금액이 100000일 때, 위 사과를 구매하고 나머지 잔액
	예제3) 곰돌이 5마리가 빵을 23개를 먹을 때, 공평하게 나눈 빵의 갯수와 나머지 빵의 갯수
	...
	*/
	...
	String name = "사과";
	int price = 2000;
	System.out.println(name + ":" + (price * 5 ));
	
	//예제2
	int money = 100000;
	System.out.println(money-price*5);
	
	//예제3
	int bear = 5;
	int bread = 23;
	System.out.println(bread/bear);
	System.out.println(bread%bear);
	...
	int money = 100000;
	System.out.println("구매후 잔액:"+appleTot);
